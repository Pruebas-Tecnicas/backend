...
public class UsuarioController {
	...
	public ResponseEntity<?> registrarCategoria(@Valid @RequestBody Usuario usuario, BindingResult result) {
		...
		// Validar si ocurre un error por parte de la base de datos
		try {
